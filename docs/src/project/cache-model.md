...
6. Test GLB `meshParams.resolution=FINE` versus explicit mesh tolerances and unit.
...
9. Test generic STL and 3MF translations with lowercase explicit resolution, tolerances, and unit.
